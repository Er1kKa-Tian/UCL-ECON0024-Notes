...
\section{Basics and Facts: Unemployment, Informality, and Frictions in Labour Markets of Developing Countries}
    ...
    \subsection{Labour Market Frictions}
        ...
        \subsubsection{Social Network: an Indicator of Information Efficiency}
            ...
            \end{figure}
            The figure above shows the proportion of employed individuals heard of their current jobs from \emphb{social networks}. This measures the importance of social network in an economy's labour market. Typically, higher shares indicate poor alternatives to gather information.
            \begin{figure}[H]
                \centering
    ...
    \subsubsection{Spatial Frictions}
        ...
        \end{figure}
        The blue area represents living places and the green area represents job locations. The red dots are job vacancy boards where people find employment information. We can see a clear spatial mismatch between jobs, workers, and information sources.
        \begin{figure}[H]
                \centering
                \includegraphics[width=5in]{images/ch6/spatial friction rio de janeiro.png}
                \caption{Spatial Frictions in Rio de Janeiro}
        \end{figure}
        Similar spatial frictions are observed in Rio de Janeiro: areas shaded green are places where low-skilled workers live, and red dots show formal job opportunities for those workers. Red dots are clustered around cities while workers live in rural areas.
...
\section{An Empirical Study by \cite{abebe_anonymity_2021}: Transport Subsidy and Job Application Workshop}
    ...
    \subsection{Treatments}
        ...
        \subsubsection{Treatment 1: Job Application Workshop}
            ...
            A workshop incorporates an orientation session and an evaluation session with certifications explaining the nature of the tests and reporting relative grades.\par
        ...
        \subsubsection{Treatment 2: Transport Subsidy}
            ...
            The cost per person is 19.8 USD including all relevant costs.
    ...
    \subsection{Sample and Data Collection}
        ...
        \subsubsection{Sampling Strategy}
            ...
            \end{itemize}
            Then individuals are randomly sampled from this list with a higher frequency from groups with higher education.
    ...
    \subsection{Estimation}
        ...
        \subsubsection{Main Regression}
            ...
            \end{itemize}
            This regression can capture the \emph{intention-to-treat (ITT)} parameter, and we cluster standard errors at the geographical clusters level.
