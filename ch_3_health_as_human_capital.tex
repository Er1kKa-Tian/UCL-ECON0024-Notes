...
\section{Education and Health: Causal Inference}
    ...
    \subsection{Clark and Royer: RDD (AER, 2013)}\label{clark_royer_RDD}
        ...
        \subsubsection{Outcomes}
            ...
            \empha{Mortality}: The two compulsory schooling laws have no effect on mortality (no discontinuity).
            ...
            \empha{Health Fair/Bad or Long-standing Illness}: The reforms cause no change in health fair or bad and long-standing illness.
            ...
            \empha{Other outcome variables}: Janke, Johnston, Propper et al. (Journal of Health Economics, 2020) analysed the same reform and showed that only the prevalence of cardiovascular diseases was affected by the reform.
