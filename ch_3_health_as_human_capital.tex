...
\section{Health Spending}
    ...
    \subsection{How Is the Health Budget Spent on Different Health Services?}
...
\begin{itemize}           
        \item \emphb{The population attributable fraction} is the proportional reduction in population disease or mortality that would occur if exposure to a risk factor were reduced to an alternative ideal exposure scenario. 
...
\subsubsection{Preventive care expenditure is easy to cut, UK}
        \begin{figure}[H]%option [H] means "strictly here"
            ...
            \end{figure}
\begin{itemize}           
        \item \empha{Preventive care expenditure has decreased since 2015. This is because it is easy to cut. Curative care is difficult to cut, so the expenditure has increased over time.}
        \end{itemize} 
...
\begin{itemize}           
        ...
        \item \emphb{Public Health Prevention} = improving public health through disease prevention
        a. Clinical interventions such as \emphb{screening and vaccinations};
        b. Population-level measures aimed at \emphb{influencing health behaviours} or addressing the social determinants of health (e.g. living conditions, education etc.).
        \item \emphb{Early Intervention} = strategies aimed to mitigate the effects of problems once they have been identified.
...
\section{$\star$ The Production of Health as Human Capital: The Grossman Model}
    ...
    \subsection{Introduction}
        ...
        \begin{itemize}
            \item Grossman (1972) studied \empha{how individuals allocate their resources to produce health}. He combined the theory of human capital and the theory of the allocation of time to explain the demand for health. Health is a unique good. We use time/resources/money to produce it and enjoy it.
            ...
            \begin{enumerate}
                    ...
                    \item Health lasts for more than one period. It \emphb{depreciates} (e.g. ageing process; if no vaccine immunity, poorer health; if don't go to the gym, poorer health) and can be analyzed like a \emphb{capital good}.
    ...
    \subsection{Preferences, Utility, and Death}
        ...
        \end{itemize}
        Length of life is \emph{endogenous}: \emphb{death} occurs when $H = H_{min}$. 
    ...
    \subsection{MEC and COC Curves}
        ...
        The \emphb{Marginal Efficiency of Health Capital (MEC)} curve shows the value of the additional healthy days gained from a 1-unit increase in the health stock (MPH). MEC is the monetary value of the marginal productivity of health stocks. [Marginal Returns of Health Capital] It is diminishing as an individual's health stock expands.
        ...
        The \emphb{Cost of Capital (COC)} curve represents the supply price of health capital (stock) or the cost of holding an additional unit. Its position is determined by the depreciation rate of the health stock ($\delta$) and the opportunity cost of holding health capital (r):
        $$COC=r+\delta$$
...
\section{ SES Inequalities in Health}\
    ...
    \subsection{Landmark Studies in Social Class Inequalities in Health in the UK}
        ...
        \subsubsection{Brief Listing}
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item Policy recommendation: \emphb{reduce poverty, spend more on prevention.}
                \end{itemize} 
        ...
        Margaret Whitehead.
                ...
                \begin{itemize}
                    ...
                    \item Similar findings and recommendations as the Black Report: \emphb{the root cause of inequalities in health was poverty}.
                \end{itemize}
        ...
        \subsubsection{The Marmot Review}
            ...
            \begin{itemize}
                ...
                \item The gaps between groups are almost the same as time passed, so \emphb{inequalities stay the same}.
            \end{itemize}
    ...
    \subsection{Why Do Health Disparities Exist?}\label{health_ineq_cause}
        ...
        \begin{enumerate}
            ...
            \item \empha{Both (i.e. health and SES) can be affected by third factors}.
...
\section{Education and Health: Causal Inference}
    ...
    \subsection{Clark and Royer: RDD (AER, 2013)}\label{clark_royer_RDD}
        ...
        \subsubsection{Discontinuity of the Running Variable}
            ...
            Specifically:
            \begin{itemize}
                \item To examine the effect of the law changes on educational attainment, we begin by graphing the relationship between the birth cohort and the \emphb{probability of completing less than nine and less than ten years of education}.
...
\end{itemize}
        \item CLM results show that \emphb{adult personality explains very little} of the education-health gradient, but Conti and Hansman (JHE, 2013) show that \emphb{child personality contributes} the education-health gradient \emphb{to an extent nearly as large as cognition}. 
...
\begin{itemize}
        \item \emphb{Non-cognitive factors} such as externalising and motivation are \emphb{at least as important as cognition in explaining the gradient}.
\end{itemize}

\subsubsection{The Early Origins of the Gradient}

\begin{itemize}
        \item Conti, Heckman et al. (AER, PPS, 2010a,b) \emphb{decompose observed educational differentials into causal components and components due to selection on early childhood human capital endowments}.
        ...
        \end{enumerate}
        \item They model \emphb{three childhood (age 10) endowments} as determinants both of education and age 30 outcomes:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item Heterogeneity in the effects (ATE=Average Treatment Effect) of post-compulsory education on smoking at age 30 as function of early endowments: \emphb{education compensates for low early non-cognitive endowments and reinforces high early cognitive endowments}.
