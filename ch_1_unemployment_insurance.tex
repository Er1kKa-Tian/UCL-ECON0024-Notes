...
\section{$\star$ Optimal Unemployment Insurance with No Moral Hazard}
    ...
    \subsection{Expected Utility Model of Unemployment}
        ...
        \subsection{Optimisation Result: Full Insurance}
            ...
            This result implies that $c^e = w-t = b = c^u$, i.e. \emphb{full insurance} -- people have the same income when unemployed as they were employed. In practice, this would mean that the net replacement rate = 1.
...
\section{$\star$ Optimal Unemployment Insurance with Moral Hazard}
    ...
    \subsection{The government's optimisation: Partial Insurance}
        ...
        Note that the Main Equation of Optimal UI implies: if $\epsilon_{p,b}>0$, then $0<c^u<c^e<w$ which means \emphb{partial insurance} will be the optimum.
