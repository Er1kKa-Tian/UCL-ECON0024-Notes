...
\section{Basic Concepts}
    ...
    \subsection{Transmission of Interest Rates and the Yield Curve}
        ...
        \subsubsection{How Does Interest Rates Affects Economy? Consumption Euler Equation}
            Here, we discuss a simple model for intuition. Assuming log utility and perfect information (no uncertainty), we can derive the \empha{Consumption Euler equation}:
    ...
    \subsection{Central Bank Mandates}
        ...
        \subsubsection{legal Mandates and Dual Mandate Trade-off}
            ...
            A dual mandate necessitates a trade-off between inflation and unemployment. According to the \empha{Neo-Keynesian Phillips Curve}:
...
\section{Policy Making and Data Collection}
    ...
    \subsection{Data during the Pandemic and The Weekly Economic Index}\label{sec:pendamic data}
        ...
        Because no traditional data on real activities satisfy the needs, prof Daniel and his colleagues developed the \emphb{Weekly Economic Index (WEI)}. They used a panel of 10 non-standard series reflecting consumer activity, industrial production, labour market, etc., that were available at daily or weekly frequency. High frequency data is very noisy, but common factors retrieved are more reliable. WEI measured weekly fluctuations and nowcast GDP well during 2020.
