...
\section{$\star$ The General Tax Schedule}
    ...
    \subsection{Three Impacts on Social Welfare}
        ...
        \subsubsection{Welfare Effect ($dW$)}
            ...
            Let $G(z)$ be the \emphb{average social value of distributing \textsterling 1 uniformly among taxpayers with income above $z$ (marginal value placed on income for individuals whose incomes are below $z$)}. The welfare effect is:
